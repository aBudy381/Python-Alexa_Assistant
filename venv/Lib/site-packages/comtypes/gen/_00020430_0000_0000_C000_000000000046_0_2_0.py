...
IFontDisp = Font
__all__ = [ 'IPicture', 'OLE_YSIZE_CONTAINER', 'Gray', 'StdFont',
           'FONTITALIC', 'IFont', 'OLE_OPTEXCLUSIVE',
           'FONTUNDERSCORE', 'FontEvents', 'OLE_COLOR', 'VgaColor',
           'Checked', 'IFontDisp', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_PIXELS', 'OLE_XSIZE_PIXELS', 'FONTNAME',
           'OLE_XPOS_HIMETRIC', 'Picture', 'OLE_XPOS_CONTAINER',
           'OLE_TRISTATE', 'LoadPictureConstants', 'IFontEventsDisp',
           'OLE_YPOS_PIXELS', 'Font', 'OLE_YPOS_HIMETRIC',
           'IPictureDisp', 'FONTBOLD', 'Unchecked', 'OLE_XPOS_PIXELS',
           'Color', 'OLE_HANDLE', 'FONTSTRIKETHROUGH',
           'OLE_CANCELBOOL', 'OLE_XSIZE_CONTAINER',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_HIMETRIC',
           'OLE_ENABLEDEFAULTBOOL', 'StdPicture', 'Default',
           'FONTSIZE', 'Monochrome']
